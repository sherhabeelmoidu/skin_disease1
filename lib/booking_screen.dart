  ...
  Future<void> _bookAppointment() async {
    if (_selectedDate == null || _selectedSlotId == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Please select a date and an available time slot'),
        ),
      );
      return;
    }
    ...
    try {
      ...
      await FirebaseFirestore.instance.runTransaction((transaction) async {
        ...
        if (!slotSnap.exists ||
            (slotSnap.data() as Map<String, dynamic>)['isBooked'] == true) {
          throw Exception(
        ...
        // Add appointment
        DocumentReference appRef = FirebaseFirestore.instance
            .collection('appointments')
            .doc();
        transaction.set(appRef, appointmentData);

        // Mark slot as booked
        transaction.update(slotRef, {'isBooked': true, 'bookedBy': user.uid});
      });
      ...
      if (widget.doctorData['uid'] != null) {
        await NotificationService.sendNotification(
          ...
          message:
              'You have a new appointment request from ${appointmentData['userName']} for ${appointmentData['date']}.',
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    hintText:
                        'Describe your symptoms or any specific concerns...',
