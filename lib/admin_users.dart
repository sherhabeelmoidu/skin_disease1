...
class _AdminUsersState extends State<AdminUsers> {
                          ...
                          child: Row(
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () {
                                  _showUserActions(context, userDoc.id, userData);
                                },
                              ),
                            ],
                          ),
  ...
  void _deleteUser(BuildContext context, String userId, Map<String, dynamic> userData) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Text('Delete User'),
        content: Text('Are you sure you want to delete ${userData['name']}? This action cannot be undone.'),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: Text('Cancel'),
